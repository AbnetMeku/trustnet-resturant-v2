      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-8 sm:grid-cols-2">
          <Card
            ...
            className={`h-40 sm:h-56 flex items-center justify-center text-2xl sm:text-3xl font-extrabold text-gray-800 bg-slate-200 rounded-2xl shadow-xl transition-transform transform focus:outline-none focus:ring-4 focus:ring-slate-300 ${
              isShiftClosedToday
