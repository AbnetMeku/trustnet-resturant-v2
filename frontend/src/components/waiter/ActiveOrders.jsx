        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {openOrders.map((order) => (
            <div
              ...
              className="relative cursor-pointer bg-white/85 dark:bg-gray-800/85 backdrop-blur-md border border-slate-200/70 dark:border-slate-700 rounded-2xl p-4 sm:p-5 shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between gap-2">
                  <h3 className="font-bold text-lg sm:text-xl text-gray-900 dark:text-white">Table {order.table.number}</h3>
